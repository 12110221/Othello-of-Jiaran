...
public class GameController {
    ...
    public void Renji(){
        ImageIcon rjpicture=new ImageIcon("picture\\renji.jpg");
   ...
   public void wrongfile(){
       ImageIcon notKnow=new ImageIcon("picture\\notknow.jpg");
    ...
    public void readFileData(String fileName) {
        ...
        int newstep=0;
        String pathname = "memory\\" + fileName;
    ...
    public static void writeDataToFile(String fileName){
        ...
        List<String> fileData = new ArrayList<>();
        try {
            File file= new File("memory\\"+fileName);
            FileWriter fileWriter = new FileWriter("memory\\"+fileName,true);
