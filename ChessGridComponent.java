...
public void bukeyi(){
    ...
    ImageIcon picture=new ImageIcon("picture\\123.jpg");
    ...
    public void result(){
        ...
        if(GameFrame.controller.getWhiteScore()==0){ ImageIcon picture=new ImageIcon("picture\\black.jpg");
        ...
        if(GameFrame.controller.getBlackScore()==0){ ImageIcon picture=new ImageIcon("picture\\white.jpg");
            JLabel label=new JLabel(picture);
            label.setLayout(null);
            result.add(label);
            Result.setLocationRelativeTo(null);
        ...
        if(GameFrame.controller.getStepcount()==60){
            ...
            if(GameFrame.controller.getBlackScore()>GameFrame.controller.getWhiteScore()){
                ImageIcon picture=new ImageIcon("picture\\black.jpg");
                JLabel label=new JLabel(picture);
                label.setLayout(null);
                result.add(label);
                Result.setLocationRelativeTo(null);
            ...
            if(GameFrame.controller.getBlackScore()<GameFrame.controller.getWhiteScore()){
                ImageIcon picture=new ImageIcon("picture\\white.jpg");
                JLabel label=new JLabel(picture);
                label.setLayout(null);
                result.add(label);
                Result.setLocationRelativeTo(null);
            ...
            if(GameFrame.controller.getBlackScore()==GameFrame.controller.getWhiteScore()){
                ImageIcon picture=new ImageIcon("picture\\equal.jpg");
                JLabel label=new JLabel(picture);
                label.setLayout(null);
                result.add(label);
                Result.setLocationRelativeTo(null);
    ...
    public void openwrong(){
            ImageIcon background=new ImageIcon("picture\\wrong.jpg");
