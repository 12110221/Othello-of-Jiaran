...
public class test{
        ...
        public static void wrongID(){
                ImageIcon notKnow=new ImageIcon("picture\\wrongid.jpg");
        ...
        public static void Exist(){
                ImageIcon notKnow=new ImageIcon("picture\\exist.jpg");
        ...
        public static void play(){
                ...
                ImageIcon picture=new ImageIcon("picture\\test.png");
//load a picture from computer
    ...
    public void mouseClicked(MouseEvent e) {
                 if(left.isSelected()) {
                         ...
                         ImageIcon picture = new ImageIcon("picture\\11.png");
        ...
        public static boolean contain(String name){
                String pathname = "account\\account.txt" ;
        ...
        public static void write(String fileName,  String name){
                ...
                try {
                        File file= new File("account\\"+fileName);
        ...
        public static void readpassword(String name){
                String pathname = "account\\password.txt" ;
                List<String> fileData = new ArrayList<>();
                try {
                        FileReader fileReader = new FileReader(pathname);
                        BufferedReader bufferedReader = new BufferedReader(fileReader);
