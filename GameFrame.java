...
public class GameFrame extends JFrame {
    ...
    private  ImageIcon back=new ImageIcon("picture\\cat.jpg");
    ...
    public void playmusic(){
        ...
        String filepath=new String("music\\6+7+8.wav");
    ...
    public GameFrame(int frameSize) {
      playmusic();
        ImageIcon backgroundIcon = new ImageIcon("picture\\background.jpg");
